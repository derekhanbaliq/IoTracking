...
/**************************************************************************//**
* function      void install_firmware(bool isTaskA)
* @brief        activates specific bin files to output depending on the boolean isTaskA
* param[in]     isTaskA a boolean for whether we are running task A or not
* @details      if isTaskA is true, then we write TaskA.bin into application, if not, we write TaskB.bin
*				
* @return
******************************************************************************/
void install_firmware(bool isTaskA) {
